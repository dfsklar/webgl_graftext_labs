(function (global, factory) {
    ...
    babelHelpers.createClass(M_SkeletalGeometry, [{
      ...
      value: function draw(expression, lights, camera, skeletalMesh, scene, renderPass_index) {
        ...
        for (var _i6 = 0; _i6 < materials.length; _i6++) {
          ...
          Shader.trySettingMatrix44ToUniform(gl, glslProgram.hashId, materials[_i6], materials[_i6]._semanticsDic, 'JOINTMATRIX', new Float32Array(flatMatrices));
        }
  ...
  var PhongShader = function (_DecalShader) {
    ...
    function PhongShader(glBoostContext, basicShader) {
      ...
      // DEFAULTS
      _this._power = 64.0; //default
      _this._efficiencyAmbient = 1.0;
      _this._efficiencyDiffuse = 1.0;
      _this._efficiencySpecular = 1.0;
      return _this;
    }
    ...
    babelHelpers.createClass(PhongShader, [{
      ...
      key: 'efficiencyAmbient',
      set: function set(value) {
        this._efficiencyAmbient = value;
      }
    }, {
      key: 'efficiencyDiffuse',
      set: function set(value) {
        this._efficiencyDiffuse = value;
      }
    }, {
      key: 'efficiencySpecular',
      set: function set(value) {
